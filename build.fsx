...
Target.create "Azure" (fun _ ->
    ...
    deployment
    |> Deploy.execute "NHS" Deploy.NoParameters
    |> ignore
)
...
Target.create "Run" (fun _ ->
    ...
    [
        ...
        // async { dotnet "fable watch src/Client --run webpack" clientPath }
        async { DotNet.exec id "fable" "watch src/Client --run webpack-dev-server" |> ignore }
        // async { npm "run start" "." }
    ]
    |> Async.Parallel
